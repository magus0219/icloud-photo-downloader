...
ARTASCOPE_DOCKER_REGISTRY_AUTH=`/bin/echo -n ${ARTASCOPE_DOCKER_REGISTRY_USERNAME}:${ARTASCOPE_DOCKER_REGISTRY_PASSWORD}|base64`
ARTASCOPE_DOCKER_REGISTRY_AUTHJSON=`/bin/echo -n {\"auths\":{\"${ARTASCOPE_DOCKER_REGISTRY}\":{\"auth\":\"${ARTASCOPE_DOCKER_REGISTRY_AUTH}\"}}} |base64`
